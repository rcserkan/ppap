...
class DrSearchReport(models.Model):
    ...
    clicked_type = fields.Selection([('product', 'Product Clicked'), ('category', 'Category Clicked'), ('autocomplete', 'Autocomplete Clicked'), ('suggestion', 'Suggestion Clicked'), ('submit', 'Submited')], string='Action', readonly=True)
