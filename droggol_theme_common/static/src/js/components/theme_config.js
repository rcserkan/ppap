    ...
    get _tabInfo() {
        return [{
            ...
            components: [
                ...
                { props: { key: 'bool_product_offers', 'label': _t('Enable product offers'), tooltip: _t("You will be able to add offers on product and show details in dialog.") }, componentRef: ThemeOptionCheckbox },
